...
public class SkippedTable {

    private SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss");

    public PdfPTable createNameForPassedTable() {
        PdfPTable table = new PdfPTable(1);
        PdfPCell cell_1 = new PdfPCell(new Phrase("Skipped tests"));
        cell_1.setBackgroundColor(Color.decode("#F0AD4E"));
     ...
     */
    public PdfPTable createSkippedTable(List<Model> passedList) {
        ...
        cell_date.setBackgroundColor(new Color(255, 204, 153));
        cell_test_name.setBackgroundColor(new Color(255, 204, 153));
        cell_test_suite.setBackgroundColor(new Color(255, 204, 153));
        cell_method_name.setBackgroundColor(new Color(255, 204, 153));
